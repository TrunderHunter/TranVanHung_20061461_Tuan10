...
import { fetchUsers, addUser, deleteUser, editUser } from './redux/action/userActions,js';
...
const TodoApp = () => {
    ...
    return ( <
        ...
        onChangeText = {
            (text) => setNewUser({...newUser, fullname: text }) }
        /> <
        TextInput style = { styles.input }
        placeholder = "Job"
        value = { newUser.job }
        onChangeText = {
            (text) => setNewUser({...newUser, job: text }) }
        /> <
        ...
        onChangeText = {
            (text) => setSelectedUser({...selectedUser, fullname: text }) }
        /> <
        TextInput style = { styles.input }
        placeholder = "Job"
        value = { selectedUser ? .job }
        onChangeText = {
            (text) => setSelectedUser({...selectedUser, job: text }) }
        /> <
